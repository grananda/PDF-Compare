...
const { setup, checkSetup } = require('./setup');
 ...
 * @returns {{ready: boolean, python: boolean, venv: boolean, pythonPath: string|null}}
 */
 ...
 * @returns {Promise<{success: boolean, venvPath: string, pythonPath: string}>}
 */
