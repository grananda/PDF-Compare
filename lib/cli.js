...
const fs = require('fs');
const { comparePDFs, checkDependencies, runSetup, getVersion } = require('./index');
...
async function main() {
    ...
    try {
        ...
        if (result.pageCount === 0) {
            ...
            // pageCount is best-effort and may be null even on a good report
            console.log(result.pageCount === null
                ? 'Report generated.'
                : `Report generated with ${result.pageCount} page(s).`);
